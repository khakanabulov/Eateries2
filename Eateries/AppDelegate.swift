...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        UITabBar.appearance().selectionIndicatorImage  = UIImage(named: "tabSelectBG") // добавляем фон когда бар выбран
        
        //  создаем вьюшку, чтобы сделать статус бар зеленным
//        let statusBarView = UIView(frame: CGRect(x: 0, y: 0, width: UIScreen.main.bounds.size.width, height: 20))
//        statusBarView.backgroundColor = #colorLiteral(red: 0.02978236787, green: 0.5389774442, blue: 0.07558702677, alpha: 1)
